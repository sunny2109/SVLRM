...
## Training
I trained and tested the model on a single NVIDIA RTX 2080Ti GPU, and this process took about 10 hours for 50w iterations. Except for learning rate update method, the ohter training strategies are the same as paper. We update lr in the following manner:
```bash
